...
class _OperatorCardState extends State<Operator_card> {
  ...
  void initState() {
    super.initState();
    _dataFuture = fetchData(widget.selectedValue!);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Model: ${widget.selectedValue}'),
        elevation: 0,
                            ...
                            return GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => Operator_timer(
